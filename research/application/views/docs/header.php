        ...
        <ul class="app-bar-menu small-dropdown">
                   ...
                   <!-- <li class="disabled"><a href="overview.html">ข่าวประชาสัมพันธ์</a></li>-->
                    ...
                    <li>
                        <a href="typography.html" class="dropdown-toggle">ลิ้งค์ที่เกี่ยวข้อง</a>
                                <ul class="d-menu" data-role="dropdown">
                                        <li><a href="grid.html">ศูนย์การดูแล</a></li>
                                        <li><a href="flexgrid.html">มูลนิธิตะวันฉาย ฯ </a></li>
                                         <li><a href="flexgrid.html">สมาคมความพิการ ฯ </a></li>
                                          <li><a href="flexgrid.html">จริยธรรม มข. </a></li>
                                          <li><a href="flexgrid.html">ระบบตัวชี้วัดทางการพยาบาล </a></li>
                                           <li><a href="flexgrid.html">ระบบ I-San register </a></li>
                                    </ul>
                    
                    
                    </li>
                    <li class="divider"></li>
                    <li><a href="tables.html">บทความให้ความรู้</a></li>
            ...
            <li>
             ...
             <li>
                ...
                <ul class="d-menu" data-role="dropdown" data-no-close="true">
                    <li><a href="http://forum.metroui.org.ua">แจ้งความประสงค์ตีพิมพ์</a></li>
                    <li><a href="https://github.com/olton/Metro-UI-CSS">หลักฐานการมีส่วนร่วม</a></li>
                    <li class="divider"></li>
                     <li><a href="https://github.com/olton/Metro-UI-CSS">หนังสือรับรองก่อนตีพิมพ์</a></li>
                    <li><a href="license.html">Check List เอกสารในการดตีพิมพ์</a></li>
                      <li><a href="license.html">แบบฟอร์มขอสนับสนุนงานวิจัย</a></li>
                       <li><a href="license.html">แบบฟอร์มขอสนับสนุนการนำเสนอผลงาน</a></li>
                </ul>
            </li>
             ...
             <li>
                ...
                <ul class="d-menu" data-role="dropdown" data-no-close="true">
                    <li><a href="http://forum.metroui.org.ua">2559</a></li>
                    <li><a href="https://github.com/olton/Metro-UI-CSS">2558</a></li>
                     <li><a href="https://github.com/olton/Metro-UI-CSS">2557</a></li>
                        <li><a href="https://github.com/olton/Metro-UI-CSS">2556</a></li>
