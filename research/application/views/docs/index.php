...
<head lang="en">
    ...
    <link rel='shortcut icon' type='image/x-icon' href='<?=base_url()?>docs/images/favicon.ico' />
    
    <title>ศูนย์วิจัยผู้ป่วยปากแหว่ง เพดานโหว่ฯ มหาวิทยาลัยขอนแก่น</title>

    <link href="<?=base_url()?>docs/css/metro.css" rel="stylesheet">
    <link href="<?=base_url()?>docs/css/metro-icons.css" rel="stylesheet">
    <link href="<?=base_url()?>docs/css/metro-responsive.css" rel="stylesheet">
    <link href="<?=base_url()?>docs/css/metro-schemes.css" rel="stylesheet">
                            ...
                            <div class="row cells3">
                                <div class="cell no-phone">
                                    <div class="image-container bordered">
                                        <div class="frame">
                                            <img src="<?=base_url()?>docs/images/whats-new.jpg">
                                        </div>
                                    </div>
                                </div>
